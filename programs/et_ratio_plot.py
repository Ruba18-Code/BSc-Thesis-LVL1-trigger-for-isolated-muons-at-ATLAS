...
Zmumu_eta=energy_cut_with_empty(MuonTree_Zmumu["muon_pt"].array(), MuonTree_Zmumu["muon_eta"].array(),0,60000)
Zmumu_phi=energy_cut_with_empty(MuonTree_Zmumu["muon_pt"].array(), MuonTree_Zmumu["muon_phi"].array(),0,60000)
Zmumu_pt=energy_cut_with_empty(MuonTree_Zmumu["muon_pt"].array(), MuonTree_Zmumu["muon_pt"].array(),0,60000)

nmin2=0
nmax2=100000
ZeroBias_eta=energy_cut_with_empty(MuonTree_ZeroBias["muon_pt"].array(), MuonTree_ZeroBias["muon_eta"].array(),14000,60000)[nmin2:nmax2]
ZeroBias_phi=energy_cut_with_empty(MuonTree_ZeroBias["muon_pt"].array(), MuonTree_ZeroBias["muon_phi"].array(),14000,60000)[nmin2:nmax2]
ZeroBias_pt=energy_cut_with_empty(MuonTree_ZeroBias["muon_pt"].array(), MuonTree_ZeroBias["muon_pt"].array(),14000,60000)[nmin2:nmax2]
...
non_empty_count1= ak.sum(ak.num(ZeroBias_eta[nmin2:nmax2]) > 0)
non_empty_count2 = ak.sum(ak.num(Zmumu_eta[nmin1:nmax1]) > 0)

dr_min=0.0
dr_max=0.3
#Compute the isolation and prepare it for plotting ZeroBias
res=muon_isolation_all_events(MuonTree_ZeroBias,ZeroBias_eta,ZeroBias_phi,dr_min,dr_max,[nmin2,nmax2])
...
# Adjust layout
fig.suptitle(rf"Heatmaps: $\frac{{E_{{iso}}}}{{E_T}}$ vs $E_T$, $\Delta R$=[{dr_min},{dr_max}]", fontsize=14)
